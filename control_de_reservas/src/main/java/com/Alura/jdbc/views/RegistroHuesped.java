...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		btnGuardar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Integer valor = Integer.valueOf(txtNreserva.getText());
				if(valor < 240) {
	...
	//	if (txtNreserva.getDate() != null && txtFechaS.getDate() != null) {		
 //     	String fechaNac = ((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText();		
//		Huesped huesped = new Huesped (txtNombre.getText(),txtApellido.getText(),java.sql.Date.valueOf(fechaNac),txtNacionalidad.getSelectedItem().toString(),txtTelefono.getText());
		//	ReservasController.cerrarConexion();
//			this.huespedController.guardar(huesped);
//			JOptionPane.showMessageDialog(this, "Registro guardado satisfactoriamente");
		//	limpiar();
//		} else {
