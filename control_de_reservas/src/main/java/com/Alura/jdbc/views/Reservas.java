...
public class Reservas extends JFrame {
	...
	//no me salio para borrar
	/*
	private void guardar() {
        if (txtFechaE.getDate() != null && txtFechaS.getDate() != null) {
            JOptionPane.showMessageDialog(this, "Los campos fecha son requeridos.");
            return;
        }

        Reserva reserva = new Reserva(java.sql.Date.valueOf(fechaE), java.sql.Date.valueOf(fechaS), txtValor.getText(), txtFormaPago.getSelectedItem().toString());
        
        var huesped = (Huesped) txtFormaPago.getSelectedItem().toString();
        this.reservaController.guardar(reserva, huesped.getId());
